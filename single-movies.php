<?php
/**
 * MovieElite Pro - Single Movie Detail View (With Direct VidVault Download Buttons)
 */
    ...
    <div class="container">
        ...
        <div id="download-section-box" style="background:var(--bg-secondary); border:1px solid var(--border-color); border-radius:var(--radius-lg); padding:25px; margin-bottom:40px; box-shadow:0 15px 30px rgba(0,0,0,0.5);">
            <h3 style="color:#fff; font-size:1.3rem; margin-bottom:10px; display:flex; align-items:center; gap:10px;">
                <i class="fa-solid fa-cloud-arrow-down" style="color:var(--accent-green);"></i> Download Movie (VidVault Direct HD Links)
            </h3>
            <p style="color:var(--text-muted); font-size:0.9rem; margin-bottom:20px;">Click any quality option below to download <?php echo esc_html($title); ?> directly:</p>
